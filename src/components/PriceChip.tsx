import { ArrowSmDownIcon, ArrowSmUpIcon, MinusIcon } from "@heroicons/react/outline";
...
export default function PriceChip({ price, lastPrice, symbol, streamType }: PriceChipProps): JSX.Element {
  ...
  return (
    ...
    >
      <div
        className={cx("flex flex-row justify-center items-center h-8 aspect-square rounded-lg", {
      ...
      <div
        className={cx("flex flex-col justify-between items-start ml-2", {
